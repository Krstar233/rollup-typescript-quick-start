(function (factory) {
    ...
    var simpSpec = createCommonjsModule(function (module, exports) {
    ...
    var simpSpec_1 = simpSpec.it;
    var simpSpec_2 = simpSpec.spec;
    var simpSpec_3 = simpSpec.runTests;
    var simpSpec_4 = simpSpec.beforeAll;
    var simpSpec_5 = simpSpec.afterAll;
    var simpSpec_6 = simpSpec.beforeEach;
    var simpSpec_7 = simpSpec.afterEach;
    ...
    var require_context_module_0_0 = simpSpec_2("spec util test", function() {
      simpSpec_4(async done => {
        done();
      });
      simpSpec_6(async done => {
        done();
      });
      simpSpec_1("should pass", async done => {
        const app = new MainApp();
        chai_1(app.run()).true;
        done();
      });
      simpSpec_7(async done => {
        done();
      });
      simpSpec_5(async done => {
        done();
      });
    });
    ...
    const files =
      (function() {
        var map = {
          './self.spec.js': require_context_module_0_0,
        };
    ...
    */
    ...
    window.onload = function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, batchImport()];
                case 1:
                    specs = _a.sent();
                    return [4 /*yield*/, simpSpec_3(specs)];
                case 2:
                    result = _a.sent();
